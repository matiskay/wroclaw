...
static char * test_polish_parser_example_2() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "5");
    queue_polish_result = queue_string_insert(queue_polish_result, "1");
    queue_polish_result = queue_string_insert(queue_polish_result, "2");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "4");
    queue_polish_result = queue_string_insert(queue_polish_result, "*");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "3");
    queue_polish_result = queue_string_insert(queue_polish_result, "-");
    /*
...
static char * test_polish_parser_example_4() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "b");
    queue_polish_result = queue_string_insert(queue_polish_result, "b");
    queue_polish_result = queue_string_insert(queue_polish_result, "*");
    queue_polish_result = queue_string_insert(queue_polish_result, "4");
    queue_polish_result = queue_string_insert(queue_polish_result, "a");
    queue_polish_result = queue_string_insert(queue_polish_result, "*");
    queue_polish_result = queue_string_insert(queue_polish_result, "c");
    queue_polish_result = queue_string_insert(queue_polish_result, "*");
    queue_polish_result = queue_string_insert(queue_polish_result, "-");
    queue_polish_result = queue_string_insert(queue_polish_result, "sqrt");
    queue_polish_result = queue_string_insert(queue_polish_result, "b");
    queue_polish_result = queue_string_insert(queue_polish_result, "-");
    queue_polish_result = queue_string_insert(queue_polish_result, "2");
    queue_polish_result = queue_string_insert(queue_polish_result, "a");
...
static char * test_polish_parser_example_3() {
    ...
    queue_polish_result = queue_string_create();
    /* 52 1 + 2 + 4 * 3 - */
    queue_polish_result = queue_string_insert(queue_polish_result, "52");
    queue_polish_result = queue_string_insert(queue_polish_result, "1");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "2");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    ...
    mu_assert("test_polish_parser_example_3 failed: \n   error, test_parser 1 != 1", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_polish_parser_example_1() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "6");
    queue_polish_result = queue_string_insert(queue_polish_result, "4");
    queue_polish_result = queue_string_insert(queue_polish_result, "5");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "*");
    queue_polish_result = queue_string_insert(queue_polish_result, "25");
    queue_polish_result = queue_string_insert(queue_polish_result, "2");
    queue_polish_result = queue_string_insert(queue_polish_result, "3");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "/");
    ...
    mu_assert("test_polish_parser_example_1 failed: \n   error, test_parser 1 != 1", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_polish_parser_big_expression() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "3");
    queue_polish_result = queue_string_insert(queue_polish_result, "7");
    queue_polish_result = queue_string_insert(queue_polish_result, "5");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "/");
    queue_polish_result = queue_string_insert(queue_polish_result, "-");
    ...
    mu_assert("test_polish_parser_big_expression failed: \n   error, test_parser 1 != 1", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_polish_parser() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "2.0");
    queue_polish_result = queue_string_insert(queue_polish_result, "3.0");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    ...
    */
    ...
    mu_assert("test_polish_parser failed -- queue_string_equal(queue_polish, queue_polish_result) ", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_polish_parser_compose() {
    ...
    queue_polish_result = queue_string_insert(queue_polish_result, "3.0");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "4.0");
    queue_polish_result = queue_string_insert(queue_polish_result, "5.0");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
    queue_polish_result = queue_string_insert(queue_polish_result, "+");
...
static char * test_polish_parser_sqrt() {
    ...
    */
    ...
    mu_assert("test_polish_parser_sqrt failed -- queue_string_equal(queue_polish, queue_polish_result) == 1", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_polish_parser_parentesis() {
    ...
    */
    ...
    mu_assert("test_polish_parser_parentesis failed ---  queue_string_equal(queue_polish, queue_polish_result) == 1", queue_string_equal(queue_polish, queue_polish_result) == 1);
    return 0;
}
...
static char * test_parser_parentesis() {
    ...
    queue_final = queue_string_insert(queue_final, "6");
    queue_final = queue_string_insert(queue_final, "*");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "4");
    queue_final = queue_string_insert(queue_final, "+");
    queue_final = queue_string_insert(queue_final, "5");
    queue_final = queue_string_insert(queue_final, ")");
    queue_final = queue_string_insert(queue_final, "-");
    queue_final = queue_string_insert(queue_final, "25");
    queue_final = queue_string_insert(queue_final, "/");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "2");
    queue_final = queue_string_insert(queue_final, "+");
    queue_final = queue_string_insert(queue_final, "3");
    queue_final = queue_string_insert(queue_final, ")");


    queue = parser(expression);
    mu_assert("test_parser_parentesis failed: \n   error, test_parser 1 != 1", queue_string_equal(queue, queue_final) == 1);
    return 0;
}

static char * test_parser_sqrt() {
    /*
    ...
    */
    ...
    queue_final = queue_string_insert(queue_final, "2.0");
    queue_final = queue_string_insert(queue_final, "sqrt");
...
static char * test_parser_sqrt_and_parentesis_expression() {
    ...
    queue_final = queue_string_insert(queue_final, "sqrt");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "4.0");
    queue_final = queue_string_insert(queue_final, "+");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "5.0");
    queue_final = queue_string_insert(queue_final, "-");
    queue_final = queue_string_insert(queue_final, "2.0");
    queue_final = queue_string_insert(queue_final, ")");
    queue_final = queue_string_insert(queue_final, ")");
    ...
    */
    ...
    mu_assert("test_parser_sqrt_and_parentesis_expression failed: \n   error, test_parser 1 != 1", queue_string_equal(queue, queue_final) == 1);
    return 0;
}
...
static char * test_parser_complex_expression() {
    ...
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "53");
    queue_final = queue_string_insert(queue_final, "+");
    queue_final = queue_string_insert(queue_final, "21");
    queue_final = queue_string_insert(queue_final, ")");
    queue_final = queue_string_insert(queue_final, "*");
    queue_final = queue_string_insert(queue_final, "2");
    queue_final = queue_string_insert(queue_final, "-");
    queue_final = queue_string_insert(queue_final, "sqrt");
    queue_final = queue_string_insert(queue_final, "(");
    queue_final = queue_string_insert(queue_final, "29");
    queue_final = queue_string_insert(queue_final, "+");
    queue_final = queue_string_insert(queue_final, "3");
    queue_final = queue_string_insert(queue_final, "*");
    queue_final = queue_string_insert(queue_final, "25");
